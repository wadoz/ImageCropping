package com.rec.imagecropping.editoractivity;

import static com.rec.imagecropping.editoractivity.EditorSaveConstants.RESTORE_PREVIEW_BITMAP;
...
import com.rec.imagecropping.graphics.CommandsPreset;
import com.rec.imagecropping.graphics.ImageProcessor;
import com.rec.imagecropping.graphics.ImageProcessorListener;
...
public class FilterActivity extends Activity /*implements ImageProcessorListener*/ {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageView.setImageResource(R.drawable.backgrount);

		Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.drawable.backgrount);
