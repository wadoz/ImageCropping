...
import com.rec.imagecropping.R;
import com.rec.imagecropping.graphics.commands.BlackFrameCommand;
import com.rec.imagecropping.graphics.commands.ColorBoostCommand;
import com.rec.imagecropping.graphics.commands.ColorFilterCommand;
import com.rec.imagecropping.graphics.commands.DecreaseColorDepthCommand;
import com.rec.imagecropping.graphics.commands.EmbossCommand;
import com.rec.imagecropping.graphics.commands.EmptyCommand;
import com.rec.imagecropping.graphics.commands.GammaCorrectionCommand;
import com.rec.imagecropping.graphics.commands.GaussianBlurCommand;
import com.rec.imagecropping.graphics.commands.GrayscaleCommand;
import com.rec.imagecropping.graphics.commands.ImageProcessingCommand;
import com.rec.imagecropping.graphics.commands.InvertColorCommand;
import com.rec.imagecropping.graphics.commands.MirrorCommand;
import com.rec.imagecropping.graphics.commands.SepiaCommand;
import com.rec.imagecropping.graphics.commands.SharpenCommand;
import com.rec.imagecropping.graphics.commands.TintCommand;
